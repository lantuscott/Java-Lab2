/******************************************************************************
 * Compilation: javac-algs4 TestAlgs4.java Execution: java-algs4 TestAlgs4
 * Dependencies: StdDraw.java http://introcs.cs.princeton.edu/mac/cover.jpg
 * 
...
public class TestAlgs4
{
	public static void main(String[] args)
	{
		...
		// StdDraw.text(0, -0.95, "Close this window to finish the
		// installation.");
